...
git clone git://busybox.net/busybox.git
    ...
    make -j8 ARCH=arm64 CROSS_COMPILE=${CROSS_COMPILE} distclean
    make -j8 ARCH=arm64 CROSS_COMPILE=${CROSS_COMPILE} defconfig
else
    cd busybox
fi
...
cd "$FINDER_APP_DIR"
make clean
make ARCH=arm64 CROSS_COMPILE=${CROSS_COMPILE} writer
